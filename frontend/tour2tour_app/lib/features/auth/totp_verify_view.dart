        ...
        child: Column(
          ...
          children: [
            ...
            AuthHeadline(
              ...
              description:
                  'Введите 6-значный код из приложения-аутентификатора, чтобы завершить вход.',
            ...
            AuthSectionChip(
              label:
                  widget.factors.isEmpty ? 'TOTP' : widget.factors.join(' · ').toUpperCase(),
            ...
            const AuthHelperText(
              text:
                  'Код обновляется каждые 30 секунд. Если код не подходит, дождитесь нового значения в приложении.',
            ),
            const SizedBox(height: 18),
            Align(
